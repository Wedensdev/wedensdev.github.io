          ...
          <div className="row">
            <div className="col-xl-12 mb-30">
              <div className="portfolio__column-item">
                <img
                  className="img__full"
                  src="assets/img/portfolio/column-1.jpg"
                  alt=""
                />
                <div className="portfolio__column-item-content">
                  <span>Business Growth</span>
                  <h4>
                    <Link to="/portfolio-details-two">Web Design</Link>
                  </h4>
                </div>
              </div>
            </div>
            <div className="col-xl-6 col-md-6 mb-30">
              <div className="portfolio__column-item">
                <img
                  className="img__full"
                  src="assets/img/portfolio/column-2.jpg"
                  alt=""
                />
                <div className="portfolio__column-item-content">
                  <span>Photography</span>
                  <h4>
                    <Link to="/portfolio-details-two">Tesla Energy</Link>
                  </h4>
                </div>
              </div>
            </div>
            <div className="col-xl-6 col-md-6 mb-30">
              <div className="portfolio__column-item">
                <img
                  className="img__full"
                  src="assets/img/portfolio/column-3.jpg"
                  alt=""
                />
                <div className="portfolio__column-item-content">
                  <span>Marketing</span>
                  <h4>
                    <Link to="/portfolio-details-two">Global Banking</Link>
                  </h4>
                </div>
              </div>
            </div>
            <div className="col-xl-12 mb-60">
              <div className="portfolio__column-item">
                <img
                  className="img__full"
                  src="assets/img/portfolio/column-4.jpg"
                  alt=""
                />
                <div className="portfolio__column-item-content">
                  <span>Solution</span>
